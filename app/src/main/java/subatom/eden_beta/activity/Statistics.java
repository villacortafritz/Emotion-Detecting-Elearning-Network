...
import subatom.eden_beta.model.Video;
...
public class Statistics extends Activity {
    ...
    private DatabaseReference mStudentRef = FirebaseDatabase.getInstance().getReference("students");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String key = NameSetter.getActivityInstance().getKey();
        ...
        Video v = new Video(key, linkReplay, d);
        DatabaseReference newRef = mStudentRef.push();
        newRef.setValue(v);
    }
