...
public class Video {
    ...
    public Video(String link, ArrayList<Double> e, ArrayList<Pair<Double,Float>> joy , ArrayList<Pair<Double,Float>> engagement , ArrayList<Pair<Double,Float>> attention, ArrayList<Pair<Double,Float>> brow_furrow, ArrayList<Pair<Double,Float>> valence) {
        //.video_id = id;
